...
public class MyBatisBeanDefinitionRegistrar implements ImportBeanDefinitionRegistrar, EnvironmentAware {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ...
        BeanDefinitionBuilder mapperScannerConfigurerBuilder = genericBeanDefinition(MapperScannerConfigurer.class);

        mapperScannerConfigurerBuilder.addPropertyValue("basePackage",  attributes.get("daoBasePackage"));
        mapperScannerConfigurerBuilder.addPropertyValue("sqlSessionFactoryBeanName", beanName);

        registry.registerBeanDefinition("configurer", mapperScannerConfigurerBuilder.getBeanDefinition());
