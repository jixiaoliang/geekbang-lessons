...
import org.geektimes.cache.model.User;
...
public class CachingTest {
    ...
    public void testLettuceUser() {
        ...
        // create the cache
        Cache<String, User> cache = cacheManager.createCache("redisCache", config);
        ...
        // cache operations
        String key = "redis-key";
        User u1 = new User(1,"sanfeng.zhang1");
        cache.put(key, u1);

        // update
        User u2 = new User(2,"siguang.li1");
        cache.put(key, u2);
